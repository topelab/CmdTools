namespace ProjectRelations2022.Commands
{
    ...
    /// <summary>
    /// OpenUsingProjectCommand handler.
    /// </summary>
    [VisualStudioContribution]
    internal class OpenUsingProjectCommand : Command
    {
        private readonly TraceSource logger;

        /// <summary>
        /// Initializes a new instance of the <see cref="OpenUsingProjectCommand"/> class.
        /// </summary>
        /// <param name="traceSource">Trace source instance to utilize.</param>
        public OpenUsingProjectCommand(TraceSource traceSource)
        {
        ...
        /// <inheritdoc />
        public override CommandConfiguration CommandConfiguration => new("%ProjectRelations2022.OpenUsingProjectCommand.DisplayName%")
        {
        ...
        public override async Task ExecuteCommandAsync(IClientContext context, CancellationToken cancellationToken)
        {
            ...
            var relationsContext = await projectRelationsOpener.OpenAsync(DTO.RelationType.Using, projectInfo);
            var remoteControl = new RelationsUserControl(relationsContext);
            await this.Extensibility.Shell().ShowDialogAsync(remoteControl, relationsContext.Title, cancellationToken);
        }
    }
}
